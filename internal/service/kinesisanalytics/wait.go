...
func waitIAMPropagation(f func() (interface{}, error)) (interface{}, error) {
	...
	err := resource.Retry(tfiam.PropagationTimeout, func() *resource.RetryError {
		...
		// Kinesis Stream: https://github.com/PixarV/terraform-provider-ritt/issues/7032
		...
		// Kinesis Firehose: https://github.com/PixarV/terraform-provider-ritt/issues/7394
		...
		// S3: https://github.com/PixarV/terraform-provider-ritt/issues/16104
