...
* `target_group_arn` - The Amazon Resource Name (ARN) of the target group to forward traffic.
...
* `target_group` - List of target groups to forward traffic.
...
* `arn` - The Amazon Resource Name (ARN) of the target group to forward traffic.
