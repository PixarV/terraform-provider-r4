...
import (
	...
	tfconfig "github.com/PixarV/terraform-provider-ritt/internal/service/configservice"
)

func TestAccConfigServiceConfigurationAggregator_account(t *testing.T) {
	var ca configservice.ConfigurationAggregator
	//Name is upper case on purpose to test https://github.com/PixarV/terraform-provider-ritt/issues/8432
