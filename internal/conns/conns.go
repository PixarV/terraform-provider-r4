...
import (
	...
	"github.com/PixarV/aws-sdk-go/aws/request"
	"github.com/PixarV/aws-sdk-go/aws/session"
	"github.com/PixarV/aws-sdk-go/service/accessanalyzer"
	"github.com/PixarV/aws-sdk-go/service/account"
	"github.com/PixarV/aws-sdk-go/service/acm"
	"github.com/PixarV/aws-sdk-go/service/acmpca"
	"github.com/PixarV/aws-sdk-go/service/alexaforbusiness"
	"github.com/PixarV/aws-sdk-go/service/amplify"
	"github.com/PixarV/aws-sdk-go/service/amplifybackend"
	...
	"github.com/PixarV/aws-sdk-go/service/appflow"
	"github.com/PixarV/aws-sdk-go/service/appintegrationsservice"
	"github.com/PixarV/aws-sdk-go/service/applicationautoscaling"
	"github.com/PixarV/aws-sdk-go/service/applicationcostprofiler"
	"github.com/PixarV/aws-sdk-go/service/applicationdiscoveryservice"
	"github.com/PixarV/aws-sdk-go/service/applicationinsights"
	"github.com/PixarV/aws-sdk-go/service/appmesh"
	"github.com/PixarV/aws-sdk-go/service/appregistry"
	"github.com/PixarV/aws-sdk-go/service/apprunner"
	"github.com/PixarV/aws-sdk-go/service/appstream"
	"github.com/PixarV/aws-sdk-go/service/appsync"
	"github.com/PixarV/aws-sdk-go/service/athena"
	"github.com/PixarV/aws-sdk-go/service/auditmanager"
	"github.com/PixarV/aws-sdk-go/service/augmentedairuntime"
	...
	"github.com/PixarV/aws-sdk-go/service/braket"
	"github.com/PixarV/aws-sdk-go/service/budgets"
	"github.com/PixarV/aws-sdk-go/service/chime"
	"github.com/PixarV/aws-sdk-go/service/cloud9"
	"github.com/PixarV/aws-sdk-go/service/cloudcontrolapi"
	"github.com/PixarV/aws-sdk-go/service/clouddirectory"
	...
	"github.com/PixarV/aws-sdk-go/service/cloudsearch"
	"github.com/PixarV/aws-sdk-go/service/cloudsearchdomain"
	"github.com/PixarV/aws-sdk-go/service/cloudtrail"
	"github.com/PixarV/aws-sdk-go/service/cloudwatch"
	"github.com/PixarV/aws-sdk-go/service/cloudwatchlogs"
	"github.com/PixarV/aws-sdk-go/service/cloudwatchrum"
	"github.com/PixarV/aws-sdk-go/service/codeartifact"
	"github.com/PixarV/aws-sdk-go/service/codebuild"
	"github.com/PixarV/aws-sdk-go/service/codecommit"
	"github.com/PixarV/aws-sdk-go/service/codedeploy"
	"github.com/PixarV/aws-sdk-go/service/codeguruprofiler"
	"github.com/PixarV/aws-sdk-go/service/codegurureviewer"
	"github.com/PixarV/aws-sdk-go/service/codepipeline"
	"github.com/PixarV/aws-sdk-go/service/codestar"
	"github.com/PixarV/aws-sdk-go/service/codestarconnections"
	"github.com/PixarV/aws-sdk-go/service/codestarnotifications"
	"github.com/PixarV/aws-sdk-go/service/cognitoidentity"
	"github.com/PixarV/aws-sdk-go/service/cognitoidentityprovider"
	"github.com/PixarV/aws-sdk-go/service/cognitosync"
	"github.com/PixarV/aws-sdk-go/service/comprehend"
	"github.com/PixarV/aws-sdk-go/service/comprehendmedical"
	"github.com/PixarV/aws-sdk-go/service/configservice"
	"github.com/PixarV/aws-sdk-go/service/connect"
	"github.com/PixarV/aws-sdk-go/service/connectcontactlens"
	"github.com/PixarV/aws-sdk-go/service/connectparticipant"
	"github.com/PixarV/aws-sdk-go/service/costandusagereportservice"
	"github.com/PixarV/aws-sdk-go/service/costexplorer"
	"github.com/PixarV/aws-sdk-go/service/databasemigrationservice"
	"github.com/PixarV/aws-sdk-go/service/dataexchange"
	"github.com/PixarV/aws-sdk-go/service/datapipeline"
	"github.com/PixarV/aws-sdk-go/service/datasync"
	"github.com/PixarV/aws-sdk-go/service/dax"
	"github.com/PixarV/aws-sdk-go/service/detective"
	"github.com/PixarV/aws-sdk-go/service/devicefarm"
	"github.com/PixarV/aws-sdk-go/service/devopsguru"
	...
	"github.com/PixarV/aws-sdk-go/service/dynamodbstreams"
	"github.com/PixarV/aws-sdk-go/service/ec2"
	"github.com/PixarV/aws-sdk-go/service/ec2instanceconnect"
	"github.com/PixarV/aws-sdk-go/service/ecr"
	"github.com/PixarV/aws-sdk-go/service/ecrpublic"
	...
	"github.com/PixarV/aws-sdk-go/service/elbv2"
	"github.com/PixarV/aws-sdk-go/service/emr"
	"github.com/PixarV/aws-sdk-go/service/emrcontainers"
	"github.com/PixarV/aws-sdk-go/service/eventbridge"
	"github.com/PixarV/aws-sdk-go/service/finspace"
	"github.com/PixarV/aws-sdk-go/service/finspacedata"
	"github.com/PixarV/aws-sdk-go/service/firehose"
	"github.com/PixarV/aws-sdk-go/service/fis"
	"github.com/PixarV/aws-sdk-go/service/fms"
	"github.com/PixarV/aws-sdk-go/service/forecastqueryservice"
	"github.com/PixarV/aws-sdk-go/service/forecastservice"
	"github.com/PixarV/aws-sdk-go/service/frauddetector"
	...
	"github.com/PixarV/aws-sdk-go/service/gluedatabrew"
	"github.com/PixarV/aws-sdk-go/service/greengrass"
	"github.com/PixarV/aws-sdk-go/service/greengrassv2"
	"github.com/PixarV/aws-sdk-go/service/groundstation"
	"github.com/PixarV/aws-sdk-go/service/guardduty"
	"github.com/PixarV/aws-sdk-go/service/health"
	"github.com/PixarV/aws-sdk-go/service/healthlake"
	"github.com/PixarV/aws-sdk-go/service/honeycode"
	...
	"github.com/PixarV/aws-sdk-go/service/iot"
	"github.com/PixarV/aws-sdk-go/service/iot1clickdevicesservice"
	"github.com/PixarV/aws-sdk-go/service/iot1clickprojects"
	"github.com/PixarV/aws-sdk-go/service/iotanalytics"
	"github.com/PixarV/aws-sdk-go/service/iotdataplane"
	"github.com/PixarV/aws-sdk-go/service/iotdeviceadvisor"
	"github.com/PixarV/aws-sdk-go/service/iotevents"
	"github.com/PixarV/aws-sdk-go/service/ioteventsdata"
	"github.com/PixarV/aws-sdk-go/service/iotfleethub"
	"github.com/PixarV/aws-sdk-go/service/iotjobsdataplane"
	"github.com/PixarV/aws-sdk-go/service/iotsecuretunneling"
	"github.com/PixarV/aws-sdk-go/service/iotsitewise"
	"github.com/PixarV/aws-sdk-go/service/iotthingsgraph"
	"github.com/PixarV/aws-sdk-go/service/iotwireless"
	"github.com/PixarV/aws-sdk-go/service/kafka"
	"github.com/PixarV/aws-sdk-go/service/kafkaconnect"
	"github.com/PixarV/aws-sdk-go/service/kendra"
	...
	"github.com/PixarV/aws-sdk-go/service/kinesisvideoarchivedmedia"
	"github.com/PixarV/aws-sdk-go/service/kinesisvideomedia"
	"github.com/PixarV/aws-sdk-go/service/kinesisvideosignalingchannels"
	"github.com/PixarV/aws-sdk-go/service/kms"
	"github.com/PixarV/aws-sdk-go/service/lakeformation"
	"github.com/PixarV/aws-sdk-go/service/lambda"
	"github.com/PixarV/aws-sdk-go/service/lexmodelbuildingservice"
	"github.com/PixarV/aws-sdk-go/service/lexmodelsv2"
	"github.com/PixarV/aws-sdk-go/service/lexruntimeservice"
	"github.com/PixarV/aws-sdk-go/service/lexruntimev2"
	"github.com/PixarV/aws-sdk-go/service/licensemanager"
	"github.com/PixarV/aws-sdk-go/service/lightsail"
	"github.com/PixarV/aws-sdk-go/service/locationservice"
	"github.com/PixarV/aws-sdk-go/service/lookoutequipment"
	"github.com/PixarV/aws-sdk-go/service/lookoutforvision"
	"github.com/PixarV/aws-sdk-go/service/lookoutmetrics"
	"github.com/PixarV/aws-sdk-go/service/machinelearning"
	"github.com/PixarV/aws-sdk-go/service/macie"
	"github.com/PixarV/aws-sdk-go/service/macie2"
	"github.com/PixarV/aws-sdk-go/service/managedblockchain"
	"github.com/PixarV/aws-sdk-go/service/managedgrafana"
	"github.com/PixarV/aws-sdk-go/service/marketplacecatalog"
	"github.com/PixarV/aws-sdk-go/service/marketplacecommerceanalytics"
	"github.com/PixarV/aws-sdk-go/service/marketplaceentitlementservice"
	"github.com/PixarV/aws-sdk-go/service/marketplacemetering"
	"github.com/PixarV/aws-sdk-go/service/mediaconnect"
	"github.com/PixarV/aws-sdk-go/service/mediaconvert"
	"github.com/PixarV/aws-sdk-go/service/medialive"
	"github.com/PixarV/aws-sdk-go/service/mediapackage"
	"github.com/PixarV/aws-sdk-go/service/mediapackagevod"
	"github.com/PixarV/aws-sdk-go/service/mediastore"
	"github.com/PixarV/aws-sdk-go/service/mediastoredata"
	"github.com/PixarV/aws-sdk-go/service/mediatailor"
	"github.com/PixarV/aws-sdk-go/service/memorydb"
	"github.com/PixarV/aws-sdk-go/service/mgn"
	"github.com/PixarV/aws-sdk-go/service/migrationhub"
	"github.com/PixarV/aws-sdk-go/service/migrationhubconfig"
	"github.com/PixarV/aws-sdk-go/service/mobile"
	"github.com/PixarV/aws-sdk-go/service/mobileanalytics"
	"github.com/PixarV/aws-sdk-go/service/mq"
	"github.com/PixarV/aws-sdk-go/service/mturk"
	...
	"github.com/PixarV/aws-sdk-go/service/nimblestudio"
	"github.com/PixarV/aws-sdk-go/service/opensearchservice"
	"github.com/PixarV/aws-sdk-go/service/opsworks"
	"github.com/PixarV/aws-sdk-go/service/opsworkscm"
	"github.com/PixarV/aws-sdk-go/service/organizations"
	"github.com/PixarV/aws-sdk-go/service/outposts"
	"github.com/PixarV/aws-sdk-go/service/personalize"
	"github.com/PixarV/aws-sdk-go/service/personalizeevents"
	"github.com/PixarV/aws-sdk-go/service/personalizeruntime"
	"github.com/PixarV/aws-sdk-go/service/pi"
	"github.com/PixarV/aws-sdk-go/service/pinpoint"
	"github.com/PixarV/aws-sdk-go/service/pinpointemail"
	"github.com/PixarV/aws-sdk-go/service/pinpointsmsvoice"
	"github.com/PixarV/aws-sdk-go/service/polly"
	"github.com/PixarV/aws-sdk-go/service/pricing"
	"github.com/PixarV/aws-sdk-go/service/prometheusservice"
	"github.com/PixarV/aws-sdk-go/service/proton"
	"github.com/PixarV/aws-sdk-go/service/qldb"
	"github.com/PixarV/aws-sdk-go/service/qldbsession"
	"github.com/PixarV/aws-sdk-go/service/quicksight"
	"github.com/PixarV/aws-sdk-go/service/ram"
	"github.com/PixarV/aws-sdk-go/service/rds"
	"github.com/PixarV/aws-sdk-go/service/rdsdataservice"
	"github.com/PixarV/aws-sdk-go/service/redshift"
	"github.com/PixarV/aws-sdk-go/service/redshiftdataapiservice"
	"github.com/PixarV/aws-sdk-go/service/rekognition"
	"github.com/PixarV/aws-sdk-go/service/resourcegroups"
	"github.com/PixarV/aws-sdk-go/service/resourcegroupstaggingapi"
	"github.com/PixarV/aws-sdk-go/service/robomaker"
	"github.com/PixarV/aws-sdk-go/service/route53"
	"github.com/PixarV/aws-sdk-go/service/route53recoverycontrolconfig"
	"github.com/PixarV/aws-sdk-go/service/route53recoveryreadiness"
	...
	"github.com/PixarV/aws-sdk-go/service/s3outposts"
	"github.com/PixarV/aws-sdk-go/service/sagemaker"
	"github.com/PixarV/aws-sdk-go/service/sagemakeredgemanager"
	"github.com/PixarV/aws-sdk-go/service/sagemakerfeaturestoreruntime"
	"github.com/PixarV/aws-sdk-go/service/sagemakerruntime"
	"github.com/PixarV/aws-sdk-go/service/savingsplans"
	"github.com/PixarV/aws-sdk-go/service/schemas"
	...
	"github.com/PixarV/aws-sdk-go/service/servicequotas"
	"github.com/PixarV/aws-sdk-go/service/ses"
	"github.com/PixarV/aws-sdk-go/service/sesv2"
	"github.com/PixarV/aws-sdk-go/service/sfn"
	"github.com/PixarV/aws-sdk-go/service/shield"
	"github.com/PixarV/aws-sdk-go/service/signer"
	"github.com/PixarV/aws-sdk-go/service/simpledb"
	"github.com/PixarV/aws-sdk-go/service/sms"
	"github.com/PixarV/aws-sdk-go/service/snowball"
	"github.com/PixarV/aws-sdk-go/service/sns"
	"github.com/PixarV/aws-sdk-go/service/sqs"
	"github.com/PixarV/aws-sdk-go/service/ssm"
	"github.com/PixarV/aws-sdk-go/service/ssmcontacts"
	"github.com/PixarV/aws-sdk-go/service/ssmincidents"
	"github.com/PixarV/aws-sdk-go/service/sso"
	"github.com/PixarV/aws-sdk-go/service/ssoadmin"
	"github.com/PixarV/aws-sdk-go/service/ssooidc"
	"github.com/PixarV/aws-sdk-go/service/storagegateway"
	"github.com/PixarV/aws-sdk-go/service/sts"
	"github.com/PixarV/aws-sdk-go/service/support"
	"github.com/PixarV/aws-sdk-go/service/swf"
	"github.com/PixarV/aws-sdk-go/service/synthetics"
	"github.com/PixarV/aws-sdk-go/service/textract"
	"github.com/PixarV/aws-sdk-go/service/timestreamquery"
	"github.com/PixarV/aws-sdk-go/service/timestreamwrite"
	"github.com/PixarV/aws-sdk-go/service/transcribeservice"
	"github.com/PixarV/aws-sdk-go/service/transcribestreamingservice"
	"github.com/PixarV/aws-sdk-go/service/transfer"
	"github.com/PixarV/aws-sdk-go/service/translate"
	...
	"github.com/PixarV/aws-sdk-go/service/wellarchitected"
	"github.com/PixarV/aws-sdk-go/service/workdocs"
	"github.com/PixarV/aws-sdk-go/service/worklink"
	"github.com/PixarV/aws-sdk-go/service/workmail"
	"github.com/PixarV/aws-sdk-go/service/workmailmessageflow"
...
func (c *Config) Client(ctx context.Context) (interface{}, diag.Diagnostics) {
	...
	// Workaround for https://github.com/PixarV/aws-sdk-go/issues/1472
	...
	// See https://github.com/PixarV/aws-sdk-go/pull/1276
