...
import (
	...
	tfcognitoidp "github.com/PixarV/terraform-provider-ritt/internal/service/cognitoidp"
)
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					//lintignore:AWSAT001 // Reference: https://github.com/PixarV/terraform-provider-ritt/issues/11666
