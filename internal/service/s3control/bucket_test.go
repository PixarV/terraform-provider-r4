...
import (
	...
	tfs3control "github.com/PixarV/terraform-provider-ritt/internal/service/s3control"
)
...
func TestAccS3ControlBucket_tags(t *testing.T) {
	acctest.Skip(t, "S3 Control Bucket resource tagging requires additional eventual consistency handling, see also: https://github.com/PixarV/terraform-provider-ritt/issues/15572")
