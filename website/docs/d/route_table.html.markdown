...
* `association.route-table-association-id` - ID of the Route Table Association.
* `association.subnet-id` - ID of the Subnet the route table is associated with.
...
* `route.gateway-id` - ID of the Internet Gateway.
